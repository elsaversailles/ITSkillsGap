...
def create_combined_visualization(all_data, listings_embeddings, output_html="combined_semantic_NC_3Drelationships.html"):
    """Creates a combined 3D visualization of semantic relationships for all courses and listings."""
    ...
    fig = px.scatter_3d(df, x="x", y="y", z="z", color="Document", hover_data=["Label"])
    ...
    fig.update_layout(
        ...
        xaxis=dict(range=[-100, 100]),  # Set x-axis range
        yaxis=dict(range=[-200, 100]),   # Set y-axis range
    )
